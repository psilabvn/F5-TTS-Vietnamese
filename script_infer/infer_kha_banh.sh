...
f5-tts_infer-cli \
--model "F5TTS_Base" \
--ref_audio "original_voice_ref/kha_banh/kha_banh_trimmed.wav" \
--ref_text "đang khai trương ở quế võ thì à hôm đấy đi ăn. đi ăn thì uống rượu say ở quế võ rồi. thế xong là anh em ở quế võ lại rủ lên ba ở quê võ. thì là đến lúc đi lên ba thì khởi nó say, nó ngủ ở dưới xe" \
